 ...
 * checking methods are chainable and throw an {@link IllegalValueException} if
 ...
 * to check against collections. Values that are {@code null} will automatically
 * be handled in custom checks as long as you use these methods, which means
 * {@link NullPointerException}s will never occur.
 * <p>
 * By default, values that are {@code null} are not allowed and will throw an
 * {@link IllegalValueException} if checked. This can be changed by calling
 * {@link #allowNull()}.
 * <p>
...
public class ValueChecker<T> {
	...
	/**
	 * Throws an {@link IllegalValueException} with the given message. The
	 * exception message should, if possible, specify specifically why the value
	 * failed a check.
	 * 
	...
	/**
	 * Calls {@link #requireIn(Collection, String)} with a generic exception
	 * message.
	 */
	 ...
	 * 
	 * @param exceptionMessage the specific exception message to use if the
	...
	/**
	 * Calls {@link #requireIn(Object[], String)} with a generic exception
	 * message.
	 */
	@SafeVarargs
	...
	/**
	 * Calls {@link #requireMatch(String, String)} with a generic exception
	 * message.
	 */
	...
	/**
	 * Calls {@link #requireNot(Collection, String)} with a generic exception
	 * message.
	 */
	 ...
	 * 
	 * @param exceptionMessage the specific exception message to use if the
	 *            value is found in the collection
	 */
	...
	/**
	 * Calls {@link #requireNot(String, Object...)} with a generic exception
	 * message.
	 */
	@SafeVarargs
	...
	/**
	 * Calls {@link #requirePassTest(Predicate, String)} with a generic
	 * exception message.
	 */
